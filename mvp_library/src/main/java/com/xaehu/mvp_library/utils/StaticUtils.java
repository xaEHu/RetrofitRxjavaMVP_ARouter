...
import com.xaehu.mvp_library.BuildConfig;
...
public class StaticUtils {
    ...
    public static void copyText(String  text){
        ClipboardManager clipboardManager = (ClipboardManager) ActivityUtils.getInstance().getAppContext().getSystemService(Context.CLIPBOARD_SERVICE);
        //创建ClipData对象
